...
name: skill-creator
description: >-
  Guia para criar skills eficazes seguindo a spec agentskills.io. Define
  principios de modularidade, estrutura de SKILL.md, organizacao de
  references e boas praticas. Use para criar ou atualizar skills no toolkit.
license: Apache-2.0
