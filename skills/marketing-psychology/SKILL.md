...
description: >-
  Aplica principios de psicologia e modelos mentais ao marketing: vieses
  cognitivos, pricing psychology, design de persuasao e frameworks de
  decisao. Organizado por desafio de negocio (baixa conversao, objecao de
  preco, construcao de confianca) com guia de aplicacao etica.
license: Apache-2.0
...
If `.claude/product-marketing-context/` directory exists, identify the relevant product from user context and read the matching file. Otherwise, if `.claude/product-marketing-context.md` exists, read it. Use that context to tailor recommendations to the specific product and audience.
